---
title: Constraints on Redrawn Area
description: "Some display controllers have specific requirements for the window area where the rendered image can be sent (e.g."
---
