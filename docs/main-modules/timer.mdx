---
title: "Timer (lv_timer)"
description: "LVGL has a built-in Timer system. You can register a function to have it be called periodically."
---
...
- refresh each display --- during the creation of each Display, a Timer is
  ...
  etc.
- read input devices --- during the creation of each [Input devices (lv_indev)](/main-modules/indev), a Timer is
...
<ApiLinkList items={["lv_api_map_v8", "lv_timer", "lv_timer_private"]} />
