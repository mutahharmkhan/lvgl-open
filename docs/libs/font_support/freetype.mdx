...
and `freetype-demos`) from its `official repository](https://sourceforge.net/projects/freetype/files/).  (The latest version is
recommended.)
...
<ApiLinkList items={["lv_freetype", "lv_freetype_private"]} />
