...
description: "LVGL provides a custom RLE (Run-Length Encoding) decompression method. It can be used to reduce binary image size."
---
...
![RLE compress statistics from a watch project](/_static/images/rle-compress-statistics.png)
...
<ApiLink name="LV_USE_RLE" /> to `1`.  The RLE image can then be used in the same way as
other images.
