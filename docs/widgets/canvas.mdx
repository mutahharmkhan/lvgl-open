...
1. Use <ApiLink name="lv_canvas_set_px_skip_invalidate" /> to set pixel colors without triggering a redraw.
2. Call <ApiLink name="lv_obj_invalidate" /> once after the loop is finished.
...
<ApiLinkList items={["lv_canvas", "lv_canvas_private"]} />
