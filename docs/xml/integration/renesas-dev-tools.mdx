---
title: Renesas
description: "First, download and install the LVGL Editor from pro.lvgl."
---
...
First, download and install the LVGL Editor from [pro.lvgl.io](https://pro.lvgl.io/#download).

LVGL provides an e2 Studio plugin to facilitate working with LVGL projects. You can
download it from [this link](https://github.com/lvgl/lvgl_editor/releases/download/v1.0.0/LVGL_Pro_e2.studio_plugin.v1.0.0.zip).
...
<Figure
  src="/_static/images/renesas/e2studio_toolbar_with_editor_plugin.png"
