---
title: Zephyr RTOS
description: The goal of this guide is to ensure a simple integration between a Zephyr project and the LVGL Editor.
---
...
how to [port a board](https://docs.zephyrproject.org/latest/hardware/porting/board_porting.html) and the valid properties
in the devicetree for [input](https://docs.zephyrproject.org/latest/build/dts/api/bindings/input/zephyr%2Clvgl-pointer-input.html).
...
**Important note:** Zephyr automatically defines the <ApiLink name="LV_CONF_INCLUDE_SIMPLE" /> symbol during
