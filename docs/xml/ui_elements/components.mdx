---
title: Components
description: Components are one of the main building blocks for creating new UI elements.
---
...
- Function calls, subject changes, or screen load/create events can be added. See [XML Events](/xml/ui_elements/events)
...
[Styles](/xml/ui_elements/styles), [Constants](/xml/ui_elements/consts), and [custom API](/xml/ui_elements/components)
...
- <ApiLink name="lv_xml_register_component_from_file" display="lv_xml_register_component_from_file(&quot;A:lvgl/examples/others/xml/my_button.xml&quot;)" />
- <ApiLink name="lv_xml_register_component_from_data" display="lv_xml_register_component_from_data(&quot;my_button&quot;, xml_data_of_my_button)" />
...
[File System (lv_fs_drv)](/main-modules/fs) and used accordingly. See that documentation for details.
...
[Data bindings via Subject](/xml/features/subjects).
...
See <api> <xml_api> for more details and [XML Syntax](/xml/xml/syntax) for all the supported types.
