---
title: lv_wl_keyboard.h
description: API reference for lv_wl_keyboard.h
api:
  functions: [lv_wayland_keyboard_create, lv_wayland_get_keyboard]
---
...
<ApiMember kind="function" name="lv_wayland_get_keyboard" file="drivers/wayland/lv_wl_keyboard.h" line={40} url="https://github.com/lvgl/lvgl/blob/master/src/drivers/wayland/lv_wl_keyboard.h#L40">
...
**Returns:** <ApiLink name="lv_indev_t" display="lv_indev_t *" /> — input device connected to keyboard, or NULL on error
...
<ApiMember kind="function" name="lv_wayland_keyboard_create" file="drivers/wayland/lv_wl_keyboard.h" line={33} url="https://github.com/lvgl/lvgl/blob/master/src/drivers/wayland/lv_wl_keyboard.h#L33">
