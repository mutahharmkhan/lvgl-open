...
|------|------|-------------|
| `style` | <ApiLink name="lv_style_t" display="lv_style_t *" /> | pointer to style to be modified |
| `value` | <ApiLink name="int32_t" /> | scale factor. Example values:<br/>- 256 or LV_SCALE_NONE: no zoom<br/>- \<256: scale down<br/>- >256: scale up<br/>- 128: half size<br/>- 512: double size |
