---
title: lv_draw_triangle_private.h
description: API reference for lv_draw_triangle_private.h
---

<RelatedHeaders name="lv_draw_triangle.h" isPrivate={true} />

## Dependencies

<FileIncludes
  includes={["lv_draw_triangle.h"]}
