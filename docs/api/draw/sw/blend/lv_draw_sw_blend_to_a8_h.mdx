---
title: lv_draw_sw_blend_to_a8.h
description: API reference for lv_draw_sw_blend_to_a8.h
api:
  functions: [lv_draw_sw_blend_color_to_a8, lv_draw_sw_blend_image_to_a8]
---
...
<ApiMember kind="function" name="lv_draw_sw_blend_color_to_a8" file="draw/sw/blend/lv_draw_sw_blend_to_a8.h" line={31} url="https://github.com/lvgl/lvgl/blob/master/src/draw/sw/blend/lv_draw_sw_blend_to_a8.h#L31">

### lv_draw_sw_blend_color_to_a8

```c
void lv_draw_sw_blend_color_to_a8(lv_draw_sw_blend_fill_dsc_t *dsc)
```
...
<ApiMember kind="function" name="lv_draw_sw_blend_image_to_a8" file="draw/sw/blend/lv_draw_sw_blend_to_a8.h" line={33} url="https://github.com/lvgl/lvgl/blob/master/src/draw/sw/blend/lv_draw_sw_blend_to_a8.h#L33">

### lv_draw_sw_blend_image_to_a8

```c
void lv_draw_sw_blend_image_to_a8(lv_draw_sw_blend_image_dsc_t *dsc)
```
