...
| `needle_length` | <ApiLink name="int32_t" /> | length of the needle<br/>- needle_length>0: needle_length=needle_length;<br/>- needle_length\<0: needle_length=radius-\|needle_length\|; |
