...
| `col_cnt` | <ApiLink name="uint32_t" /> |  |
| `row_cnt` | <ApiLink name="uint32_t" /> |  |
| `cell_data` | <ApiLink name="lv_table_cell_t" display="lv_table_cell_t **" /> |  |
| `row_h` | <ApiLink name="int32_t" display="int32_t *" /> |  |
| `col_w` | <ApiLink name="int32_t" display="int32_t *" /> |  |
| `col_act` | <ApiLink name="uint32_t" /> |  |
| `row_act` | <ApiLink name="uint32_t" /> |  |
...
<FileIncludes
  includes={["lv_table.h", "lv_obj_private.h"]}
