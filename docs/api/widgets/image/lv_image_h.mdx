...
|------|------|-------------|
| `obj` | <ApiLink name="lv_obj_t" display="lv_obj_t *" /> | pointer to an image object |
| `zoom` | <ApiLink name="uint32_t" /> | the zoom factor. Example values:<br/>- 256 or LV_SCALE_NONE: no zoom<br/>- \<256: scale down<br/>- >256: scale up<br/>- 128: half size<br/>- 512: double size |
