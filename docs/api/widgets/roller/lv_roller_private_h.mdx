...
| `sel_opt_id` | <ApiLink name="uint32_t" /> | Index of the current option |
| `sel_opt_id_ori` | <ApiLink name="uint32_t" /> | Store the original index on focus |
| `inf_page_cnt` | <ApiLink name="uint32_t" /> | Number of extra pages added to make the roller look infinite |
| `mode` | <ApiLink name="lv_roller_mode_t" /> |  |
| `moved` | <ApiLink name="uint32_t" /> |  |
...
<FileIncludes
  includes={["lv_roller.h", "lv_obj_private.h"]}
