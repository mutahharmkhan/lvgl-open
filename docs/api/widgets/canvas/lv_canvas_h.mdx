...
| `index` | <ApiLink name="uint8_t" /> | the palette color to set:<br/>- for <ApiLink name="lv_color_format_t" display="LV_COLOR_FORMAT_I1" />: 0..1<br/>- for <ApiLink name="lv_color_format_t" display="LV_COLOR_FORMAT_I2" />: 0..3<br/>- for <ApiLink name="lv_color_format_t" display="LV_COLOR_FORMAT_I4" />: 0..15<br/>- for <ApiLink name="lv_color_format_t" display="LV_COLOR_FORMAT_I8" />: 0..255 |
