---
title: MicroPython
description: "MicroPython is Python for microcontrollers. Using MicroPython, you can write Python3 code and run it even on a bare metal architecture with limited resources."
---

## What is MicroPython?

[MicroPython](http://micropython.org/) is Python for microcontrollers.  Using
...
| `Popular` | Many platforms are supported. The user base is growing larger. Notable forks: - [MicroPython](https://github.com/micropython/micropython) - [CircuitPython](https://github.com/adafruit/circuitpython) - [MicroPython_ESP32_psRAM_LoBo](https://github.com/loboris/MicroPython_ESP32_psRAM_LoBo) |
...
LVGL is an [Object-Oriented Component Based](https://blog.lvgl.io/2018-12-13/extend-lvgl-objects)
...
- Make LVGL accessible to a larger audience. No need to know C to create a nice GUI
  ...
  [CircuitPython vision](https://learn.adafruit.com/welcome-to-circuitpython/what-is-circuitpython).
...
Many [LVGL examples](/examples) are available also for MicroPython. Just click the link!
...
[Click here to learn more about building and running the Unix port.](https://github.com/lvgl/lv_micropython)

### Embedded Platforms

In the end, the goal is to run it all on an embedded platform. Both MicroPython and LVGL can
be used on many embedded architectures. [lv_micropython](https://github.com/lvgl/lv_micropython)
...
- LVGL is a git submodule inside [lv_micropython](https://github.com/lvgl/lv_micropython)
  (LVGL is a git submodule of [lv_binding_micropython](https://github.com/lvgl/lv_binding_micropython)
  which is itself a submodule of [lv_micropython](https://github.com/lvgl/lv_micropython)).
...
For a summary of coding conventions to follow see the [Coding Style](/contributing/coding_style).

### Memory Management

- When LVGL runs in MicroPython, all dynamic memory allocations (<ApiLink name="lv_malloc" />) are handled by MicroPython's memory
...
- `path_cb` field can also be assigned directly in the Python code because it's a member of <ApiLink name="lv_anim_t" />
  which contains `user_data` field, and <ApiLink name="lv_anim_path_cb_t" /> receive <ApiLink name="lv_anim_t" /> as its first argument.
...
- Various discussions: [here](https://github.com/lvgl/lvgl/pull/3294#issuecomment-1184895335)
  and [here](https://github.com/lvgl/lvgl/issues/1763#issuecomment-762247629)
  and [here](https://github.com/lvgl/lvgl/issues/316#issuecomment-467221587)
