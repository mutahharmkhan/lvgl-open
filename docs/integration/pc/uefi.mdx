---
title: UEFI
description: The UEFI display/input driver offers support for using LVGL to create UIs in UEFI environments.
---

## Overview

The **UEFI** display/input [driver](https://github.com/lvgl/lvgl/tree/master/src/drivers/uefi)
